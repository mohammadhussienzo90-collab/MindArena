...
QUEST_TEMPLATES = {
    "logic_fortress": [
        {"slug": "lf-quest-patterns", "title_en": "Pattern Master", "title_ar": "سيد الأنماط",
         ...
         "challenge_slugs": ["lf-pattern-1", "lf-pattern-2", "lf-pattern-3"]},
        ...
        {"slug": "lf-quest-advanced", "title_en": "Fortress Guardian", "title_ar": "حارس القلعة",
         ...
         "challenge_slugs": ["lf-spatial-1", "lf-timed-1", "lf-code-1", "lf-analogy-1", "lf-sequence-1", "lf-deduction-1"]},
    ],
    "emotion_ocean": [
        {"slug": "eo-quest-empathy", "title_en": "Empathy Explorer", "title_ar": "مستكشف التعاطف",
         ...
         "challenge_slugs": ["eo-empathy-1", "eo-empathy-2", "eo-emotion-read-1"]},
        {"slug": "eo-quest-self", "title_en": "Inner Navigator", "title_ar": "الملاح الداخلي",
         ...
         "challenge_slugs": ["eo-self-awareness-1", "eo-regulation-1", "eo-regulation-2"]},
        {"slug": "eo-quest-connect", "title_en": "Heart Bridge", "title_ar": "جسر القلب",
         ...
         "challenge_slugs": ["eo-social-1", "eo-gratitude-1", "eo-creative-1", "eo-future-letter-1"]},
    ],
    "creativity_nebula": [
